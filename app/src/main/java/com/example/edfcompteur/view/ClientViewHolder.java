...
import com.example.edfcompteur.controleur.AddCompteurActivity;
import com.google.android.material.button.MaterialButton;
    ...
    public class ClientViewHolder extends RecyclerView.ViewHolder {
        ...
        public ClientViewHolder(View itemView) { super(itemView);
        ...
        public void bind(int textIdClient, String textNomClient, String textPrenomClient) {
            ...
            compteurClientCard.setOnClickListener(v -> { Intent intent = new Intent(v.getContext(), AddCompteurActivity.class);
                intent.putExtra("ID_CLIENT", textIdClient); v.getContext().startActivity(intent);
            });
        }
